...
tests = Test.create!([
  ...
  { title: "CSS", level: 1, category_id: categories[0] },
  { title: "JavaScript", level: 2, category_id: categories[0] },
  { title: "Ruby", level: 3, category_id: categories[1] },
  { title: "Ruby on Rails", level: 3, category_id: categories[1] },
  { title: "Swift", level: 3, category_id: categories[2] },
  { title: "Kotlin", level: 3, category_id: categories[2] },
])
...
users = User.create!([
    ...
    {name: 'Kate', login: 'kate90', password: 'kate-brown1990', type: 'admin'},
])
